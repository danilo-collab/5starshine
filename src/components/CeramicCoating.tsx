export default function CeramicCoating() {
  return (
    <section id="coating" className="mx-auto max-w-[1180px] px-7 py-[30px]">
      <div className="grid grid-cols-2 items-center gap-10 rounded-2xl border border-border bg-bg-card p-[30px]">
        <div className="p-1.5">
          <div className="mb-3 font-archivo text-xs font-bold uppercase tracking-[0.2em] text-accent">Long-Lasting Protection</div>
          <h2 className="mb-3.5 font-archivo text-4xl font-extrabold leading-[1.05] text-white">Ceramic Coating</h2>
          ...
          <div className="mb-6 grid grid-cols-3 gap-3">
            {[
              ...
              <div key={c.title} className="rounded-[11px] border border-border-inner bg-bg-inner px-[13px] py-4">
                {c.icon}
          ...
          <a href="#formula" className="inline-flex items-center gap-[9px] rounded-lg bg-accent px-[22px] py-[13px] font-barlow text-sm font-bold text-bg transition-[filter] hover:brightness-110">
        ...
        <div
          className="flex h-[330px] flex-col items-center justify-center gap-2.5 rounded-xl border border-dashed border-border-btn bg-[#0d100c]"
