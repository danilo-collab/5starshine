...
export default function Formula1051() {
  return (
    <section id="formula" className="mx-auto max-w-[1180px] px-5 py-6 sm:px-7 md:py-[30px]">
      <ScrollReveal>
        <div className="relative grid grid-cols-1 items-center gap-8 rounded-2xl border border-border bg-bg-card p-5 sm:p-6 lg:grid-cols-2 lg:gap-10">
          <div
            className="flex h-[240px] flex-col items-center justify-center gap-2.5 rounded-xl border border-dashed border-border-btn bg-[#0d100c] sm:h-[320px]"
          ...
          <div className="p-0 lg:p-1.5">
            <div className="absolute right-5 top-5 inline-flex items-center gap-[7px] rounded-[7px] border border-accent px-3 py-[7px] font-archivo text-[11px] font-bold uppercase tracking-[0.12em] text-accent sm:right-6 sm:top-6">
            ...
            <h2 className="mb-1.5 font-archivo font-extrabold leading-[1.06] text-white" style={{ fontSize: "clamp(26px, 3.5vw, 33px)" }}>Formula 1051 — 10 Year Coating</h2>
            ...
            <p className="mb-5 max-w-[440px] font-barlow text-[15px] leading-relaxed text-text-muted">
            ...
            <div className="mb-6 grid max-w-[440px] grid-cols-1 gap-3 sm:grid-cols-2 sm:gap-x-[18px] sm:gap-y-4">
              {[
                {
