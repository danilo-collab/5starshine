...
export default function Footer() {
  return (
    <footer className="bg-bg px-7 pb-[26px] pt-12">
      <div className="mx-auto grid max-w-[1180px] grid-cols-[1.5fr_1fr_1fr_1.1fr_1fr] gap-[34px]">
        {/* Brand */}
        <div>
          <Image src="/assets/5star-logo.png" alt="5 Star Shine Auto Detailing" width={160} height={78} className="mb-3.5 block h-[78px] w-auto" />
          ...
          <div className="flex gap-2.5">
            <a href="#top" className="flex h-[34px] w-[34px] items-center justify-center rounded-full border border-social-border text-text-muted transition-colors hover:border-accent hover:text-accent">
            ...
            <a href="#top" className="flex h-[34px] w-[34px] items-center justify-center rounded-full border border-social-border font-archivo text-sm font-bold text-text-muted transition-colors hover:border-accent hover:text-accent">
              G
            </a>
            <a href="#top" className="flex h-[34px] w-[34px] items-center justify-center rounded-full border border-social-border text-text-muted transition-colors hover:border-accent hover:text-accent">
        ...
        <div>
          ...
          <div className="flex flex-col gap-[13px]">
            <a href="tel:6025550198" className="flex items-center gap-2.5 font-barlow text-sm text-text-muted transition-colors hover:text-white">
              <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="var(--color-accent)" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="flex-none"><path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72c.13.81.36 1.6.7 2.34a2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.74-1.27a2 2 0 0 1 2.11-.45c.74.34 1.53.57 2.34.7A2 2 0 0 1 22 16.92z"/></svg>
              (602) 555-0198
            </a>
            <a href="mailto:info@5starshine.com" className="flex items-center gap-2.5 font-barlow text-sm text-text-muted transition-colors hover:text-white">
              <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="var(--color-accent)" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="flex-none"><rect x="3" y="5" width="18" height="14" rx="2"/><path d="m3 7 9 6 9-6"/></svg>
              info@5starshine.com
            </a>
            <div className="flex items-start gap-2.5 font-barlow text-sm leading-[1.4] text-text-muted">
              <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="var(--color-accent)" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="mt-0.5 flex-none"><path d="M12 21s-7-5.5-7-11a7 7 0 0 1 14 0c0 5.5-7 11-7 11z"/><circle cx="12" cy="10" r="2.5"/></svg>
        ...
        <div>
          ...
          <div className="inline-flex items-center gap-[9px] rounded-[9px] border border-cta-border px-[13px] py-[9px]">
            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="var(--color-accent)" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" className="flex-none">
      ...
      {/* Bottom */}
      <div className="mx-auto mt-8 flex max-w-[1180px] justify-end gap-6 border-t border-border-subtle pt-[18px]">
